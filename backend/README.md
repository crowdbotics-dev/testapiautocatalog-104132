...
## Project Structure
    ...
    ├── testapiautocatalog_104132  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_104132`
...
2. Clone this repo and `cd testapiautocatalog_104132`
